...
class FieldsControllerTest < ActionController::TestCase
  ...
  test "should create field" do
    assert_difference('Field.count') do
      post :create, field: { name: @field.name, organization_id: @field.organization_id, permalink: @field.permalink }
    end
  ...
  test "should update field" do
    patch :update, id: @field, field: { name: @field.name, organization_id: @field.organization_id, permalink: @field.permalink }
    assert_redirected_to field_path(assigns(:field))
  end
