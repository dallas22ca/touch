...
class SegmentsControllerTest < ActionController::TestCase
  ...
  test "should create segment" do
    assert_difference('Segment.count') do
      post :create, segment: { filters: @segment.filters, name: @segment.name, organization_id: @segment.organization_id }
    end
  ...
  test "should update segment" do
    patch :update, id: @segment, segment: { filters: @segment.filters, name: @segment.name, organization_id: @segment.organization_id }
    assert_redirected_to segment_path(assigns(:segment))
  end
